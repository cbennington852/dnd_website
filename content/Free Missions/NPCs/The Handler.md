...
> **Call off the cops:**
> The handler can call the cops away from the players, or get the players released from jail. He accomplishes this through rank, beurocracic, legal, and other means.

> **Hidden Stashes:**
> The handler has access to the Redline hidden explosive, and item stashes located around the reigion he operates in. For the free missions and main story campaign is this region of north cascadia. 

> **Safe houses:**
> The handler also has accessed to a Redline hidden network of safe houses. He can and will direct players to drop dangerous items off at these locations or give the players a place to rest and hide from threats,

> **Mobile Fortress:**
> The handler lives in a specially outfitted and augmented RV. This is an armoured camouflaged vehicle with a personal stash of weapons, items, and Redline specific data. It also serves as a meeting place to meet with the Agents.
...
<section>
  ...
  <div class="grid-container-3">
    <div class="column">
      ...
      <input type="text"  name="sex" placeholder="Example : Male" value="Male" disabled>
    </div>
    <div class="column">
      <label for="username">Age & DOB:</label>
    <input type="text"  name="age_and_dob" placeholder="Example : 19 , August 17th 2004" value="46 , January 7th 1980" disabled>
    </div>
    <div class="column">
      <label for="username">Education:</label>
      <input type="text"  name="education" placeholder="Example : B.S. International Relations" value="M.S. English" disabled>
    </div>
  </div>
  <div class="grid-container">
    ...
    <div class="column">
      <div id="health-bar" class="health-bar">
        <span> <input id=current-health type="number" class="current-health"   name="current_health" placeholder="16"><span id=second-part-health>  / 16 hp  </span></span>
  ...
  <div class="grid-container">
    <div class="column">
      <table style="width: 95%;">
        ...
        <tbody>
          <tr class="weapon-row">
            <td class="weapon-box" ><input class="table-input text-input" type="text" name="weapon_1" value="Colt Viper"></td>
            <td><input class="table-input" type="text" name="weapon_1_range" value="25m"></td>
            <td><input class="table-input" type="text" name="weapon_1_damage" value="1D12"></td>
            ...
            <td><input class="table-input" type="number" name="weapon_1_hit_c" value="0" min="0" max="100"></td>
          </tr>
          <tr class="weapon-row">
...
let coreStatsData = [45, 80, 35, 40, 55, 60]; // Example Values if not loading correctly
